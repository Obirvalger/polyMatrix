...
Период $\tau$ называется невырожденным, если
...
\begin{myth}
\label{th1}
Если $\tilde{0} \not\in \Pi(\tau)$, то $\tau$ невырожденный период.
\end{myth}
\begin{proof}
...
\begin{myst} Все симметрические периодические функции пятизначной логики с периодами длины 3, отличными от $[0,0,0], [1,1,1],
